...
//           // Circuit breaker: if too many consecutive failures, redirect to login
//           consecutiveFailures++;
//           if (consecutiveFailures >= maxConsecutiveFailures) {
//             console.log('Too many consecutive 401 errors, redirecting to login');
//             window.location.href = '/login';
//             return Promise.reject(new Error('Too many consecutive 401 errors'));
//           }
...
//             // The new tokens are set in cookies by the backend
...
// Moved to auth.ts to resolve circular import issue.